package s.composite.deba.api.exception;
...
@ControllerAdvice
public class DebaCompositeServiceExceptionHandler extends ResponseEntityExceptionHandler {
  private static final Logger LOG =
      LoggerFactory.getLogger(DebaCompositeServiceExceptionHandler.class);
