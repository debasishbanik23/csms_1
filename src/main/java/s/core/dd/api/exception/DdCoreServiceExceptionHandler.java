package s.core.dd.api.exception;
...
@ControllerAdvice
public class DdCoreServiceExceptionHandler extends ResponseEntityExceptionHandler {
  private static final Logger LOG = LoggerFactory.getLogger(DdCoreServiceExceptionHandler.class);
